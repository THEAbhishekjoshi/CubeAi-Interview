        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 font-medium">Candidate: {candidateName}</p>
            </div>
          </div>
      ...
      <div className="w-[400px] bg-white border-l border-slate-200 p-8 flex flex-col">
        <div className="mb-6">
          ...
          <div className="relative aspect-[3/4] bg-slate-900 rounded-3xl overflow-hidden shadow-2xl border-4 border-slate-50">
            <video
              ref={videoRef}
              className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-500 ${videoStatus !== 'success' ? 'opacity-0' : 'opacity-100'
                }`}
              autoPlay
              playsInline
              muted
